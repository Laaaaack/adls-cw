...
def int_add_gen(
    ...
    """
    This script generates a fixed-point add in HLS
    """
    ...
    y_frac_width = max(x_frac_width, w_frac_width)
    y_width = max(x_width - x_frac_width, w_width - w_frac_width) + 1 + y_frac_width
    y_row = x_row
    y_col = x_col
...
"""
    ...
    buff = f"""
// Add:
void int_add_{op_id}(hls::stream<{type_in0}> &data_in_0, 
