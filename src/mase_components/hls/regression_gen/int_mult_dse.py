...
from hls.int_arith import int_mult_gen
from hls import HLSWriter


def int_mult_dse(mode=None, top=None, threads=16):
                ...
                for x_frac_width in x_frac_widths:
                    for w_width in w_widths:
                        for w_frac_width in w_frac_widths:
                            ...
                            file_name = f"x{i}_int_mult_{x_row}_{x_col}_{x_width}_{x_frac_width}_{w_width}_{w_frac_width}"
                            ...
                            if mode in ["codegen", "all"]:
                                ...
                                top_name = f"int_mult_{writer.op_id-1}"
    ...
    if mode in ["codegen", "all"]:
        ...
        bash_gen(commands, top, "int_mult")
