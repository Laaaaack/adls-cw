...
from mase_cocotb.random_test import RandomSource, RandomSink, check_results_signed
import mase_cocotb.utils as utils
        ...
        for i in range(self.samples):
            ...
            for j in range(self.iterations):
                ...
                for k in range(self.parallelism):
                    s = [
                        utils.binary_decode(self.data_in.data[data_idx][h])
                        * utils.binary_decode(
