...
def runner():
    ...
    verilog_sources = [
        "../../../../components/binary_arith/binary_activation_binary_matmul_core.sv",
    ...
    runner.build(
        ...
        hdl_toplevel="binary_activation_binary_matmul_core",
        build_args=extra_args,
    )

    runner.test(
        hdl_toplevel="binary_activation_binary_matmul_core",
        test_module="binary_activation_binary_matmul_core_tb",
    )
