...
from .sparse_config_llama import parse_llama_sparse_config
...
class LlamaSparseConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if sparse_config is not None:
            sparse_config = parse_llama_sparse_config(sparse_config, num_hidden_layers)
    ...
    def __setattr__(self, key, value):
        if key == "sparse_config" and value is not None:
            value = parse_llama_sparse_config(
