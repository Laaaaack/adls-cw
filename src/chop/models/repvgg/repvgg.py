...
# - deploy
# deploy variable controls whether RegVGG model needs to be transformed into deploy
# format.

# - pretrained
# pretrained RepVGG model is not supported at this stage, so it's set to be False
# ---------------------------------------------------
...
func_dict = {
    "RepVGG-A0": get_repvgg_a0,
    "RepVGG-A1": get_repvgg_a1,
    "RepVGG-A2": get_repvgg_a2,
    "RepVGG-B0": get_repvgg_b0,
    "RepVGG-B1": get_repvgg_b1,
    "RepVGG-B1g2": get_repvgg_b1g2,
    "RepVGG-B1g4": get_repvgg_b1g4,
    "RepVGG-B2": get_repvgg_b2,
    "RepVGG-B2g2": get_repvgg_b2g2,
    "RepVGG-B2g4": get_repvgg_b2g4,
    "RepVGG-B3": get_repvgg_b3,
    "RepVGG-B3g2": get_repvgg_b3g2,
    "RepVGG-B3g4": get_repvgg_b3g4,
    "RepVGG-D2se": get_repvgg_d2se,  #   Updated at April 25, 2021. This is not reported in the CVPR paper.
}
