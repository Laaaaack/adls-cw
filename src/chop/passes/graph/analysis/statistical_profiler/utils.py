def set_meta_arg_stat(node, entry: str, stat):
    node.meta["mase"].parameters["software"]["args"][entry]["stat"] = stat


def get_meta_arg_stat(node, entry: str):
    return node.meta["mase"].parameters["software"]["args"][entry]["stat"]
...
# from ...transforms.quantize.quantizers.integer import integer_fraction
