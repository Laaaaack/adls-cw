...
class Variable:
    def __init__(self, row_dim, col_dim):
        ...
        :param row_dim: dimension of the row
        :type row_dim: int
        :param col_dim: dimension of the column
        :type col_dim: int
        """
...
class AttentionBlockI:
    def __init__(self, tunable, target_len, num_head, embed_dim, head_dim):
        ...
        :param tunable: open tunable
        :type tunable: _type_
        :param target_len: _description_
        :type target_len: _type_
        :param num_head: _description_
        :type num_head: _type_
        :param embed_dim: _description_
        :type embed_dim: _type_
        :param head_dim: _description_
        :type head_dim: _type_
        """
