...
def tanh_integer(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_binary(x, inplace=False, config=None):
...
def tanh_ternary(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_minifloat_denorm(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_minifloat_ieee(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_block_fp(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_block_minifloat(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
...
def tanh_block_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.tanh(x, inplace=inplace)
    else:
