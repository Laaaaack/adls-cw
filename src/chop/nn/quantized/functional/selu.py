...
def selu_integer(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_binary(x, inplace=False, config=None):
...
def selu_ternary(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_minifloat_denorm(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_minifloat_ieee(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_block_fp(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_block_minifloat(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
...
def selu_block_log(x, inplace=False, config=None):
    bypass = config.get("bypass", False)
    if bypass:
        return F.selu(x, inplace=inplace)
    else:
