...
class _SoftsignBase(torch.nn.Softsign):
    ...
    def forward(self, x: Tensor) -> Tensor:
        if self.bypass:
            ...
            return F.softsign(x, self.inplace)
...
class SoftsignInteger(_SoftsignBase):
    bypass = None
...
class SoftsignMinifloatDenorm(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftsignMinifloatIEEE(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftsignLog(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftsignBlockFP(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftsignBlockMinifloat(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
        assert config is not None, "config is None!"
        self.config = config
...
class SoftsignBlockLog(_SoftsignBase):
    def __init__(self, inplace: bool = False, config: dict = None):
        super().__init__(inplace)
...
class SoftsignBinary(_SoftsignBase):
    bypass = None
...
class SoftsignTernary(_SoftsignBase):
    bypass = None
